...
class Tester(BaseTester):
    ...
    def __init__(self, *args, **kwargs):
        ...
        print('Initializing zamia model...')
        ...
        self.asr = NnetLatticeFasterRecognizer.from_files(
            "/home/chris/git/pykaldi/examples/setups/zamia/exp/nnet3_chain/tdnn_f/final.mdl",
            "/home/chris/git/pykaldi/examples/setups/zamia/exp/nnet3_chain/tdnn_f/graph/HCLG.fst",
            "/home/chris/git/pykaldi/examples/setups/zamia/data/lang/words.txt",
        ...
        self.feats_rspec = (
            f"ark:compute-mfcc-feats --config=/home/chris/git/pykaldi/examples/setups/zamia/conf/mfcc_hires.conf scp:{scp_fn} ark:- |"
        )
        self.ivectors_rspec = (
            f"ark:compute-mfcc-feats --config=/home/chris/git/pykaldi/examples/setups/zamia/conf/mfcc_hires.conf scp:{scp_fn} ark:- |"
            f"ivector-extract-online2 --config=/home/chris/git/pykaldi/examples/setups/zamia/conf/ivector_extractor.conf " \
            f"ark:/home/chris/git/pykaldi/examples/setups/zamia/data/test/spk2utt ark:- ark:- |"
        )
